...
class WorkOrderController extends Controller
{
    ...
    public function store(WorkOrderRequest $request)
    {
        ...
        $workOrder->maintenanceTechnician->user->notify((new NewWorkOrder($workOrder, 'Vous avez un nouveau Ordre de Travail'))->delay($when));

        $workRequest->user->notify((new NewWorkRequest($workRequest, 'Votre demande est en cours de traitment'))->delay($when));
